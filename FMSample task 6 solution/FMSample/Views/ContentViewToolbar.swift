...
struct ContentViewToolbar: ToolbarContent {
    ...
    var body: some ToolbarContent {
        ToolbarItem {
            Menu {
                ...
                .disabled(!isDocumentCameraAvailable)
#endif
            } label: {
    ...
    private var isDocumentCameraAvailable: Bool {
#if os(iOS)
        // Note: despite returning true, camera availability might still be limited due to permissions, Screen Time, or other reasons.
