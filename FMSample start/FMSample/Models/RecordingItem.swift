...
class RecordingItem: MeetingItem {
    ...
    func suggestedTitle() async throws -> String? {
        ...
        let session = LanguageModelSession(
            ...
            instructions: "You are an expert headline writer who takes meeting transcripts as input: from those notes you MUST generate your best suggested title, with no other text."
        )
